...
public class Hobgoblin implements BaseNPC {
    ...
    public Hobgoblin() {
        ...
        drops.add(new ItemData(5282, 0.0025940337224383916f, "1", false));
        drops.add(new ItemData(5296, 0.0024154589371980675f, "1", false));
        drops.add(new ItemData(5281, 0.001610305958132045f, "1", false));
        drops.add(new ItemData(5297, 0.001610305958132045f, "1", false));
        drops.add(new ItemData(5106, 0.001162925921618793f, "1", false));
        drops.add(new ItemData(5298, 0.00107342206955775f, "1", false));
        drops.add(new ItemData(5280, 0.00107342206955775f, "1", false));
        drops.add(new ItemData(5299, 0.0008050881571532082f, "1", false));
        drops.add(new ItemData(22873, 0.0007156659271452086f, "1", false));
        drops.add(new ItemData(5300, 0.0004472872031131189f, "1", false));
        drops.add(new ItemData(559, 0.015625f, "6", false));
        drops.add(new ItemData(5301, 0.0003578201595877912f, "1", false));
        drops.add(new ItemData(5302, 0.0002683699210992432f, "1", false));
        drops.add(new ItemData(5303, 0.0001789132807328288f, "1", false));
        drops.add(new ItemData(5304, 0.00008945584012452252f, "1", false));
        drops.add(new ItemData(995, 0.265625f, "15", false));
        drops.add(new ItemData(995, 0.1875f, "5", false));
        drops.add(new ItemData(995, 0.0546875f, "10", false));
        drops.add(new ItemData(995, 0.03125f, "28", false));
        ...
        drops.add(new ItemData(23182, 0.014285714285714285f, "1", false));
        drops.add(new ItemData(6802, 0.0002f, "1", false));
        ...
        drops.add(new ItemData(1237, 0.0234375f, "1", false));
        ...
        drops.add(new ItemData(995, 0.125f, "28", false));
        drops.add(new ItemData(995, 0.09375f, "5", false));
        drops.add(new ItemData(1207, 0.0234375f, "1", false));
        drops.add(new ItemData(6306, 0.0078125f, "1", false));
        drops.add(new ItemData(6306, 0.09375f, "5", false));
        drops.add(new ItemData(6306, 0.125f, "15", false));
        drops.add(new ItemData(6306, 0.125f, "28", false));
        drops.add(new ItemData(6306, 0.0234375f, "42", false));
        drops.add(new ItemData(6306, 0.03125f, "62", false));
        drops.add(new ItemData(225, 0.171875f, "1", false));
        drops.add(new ItemData(1239, 0.015625f, "1", false));
        drops.add(new ItemData(1241, 0.015625f, "1", false));
        ...
        drops.add(new ItemData(5100, 0.012254901960784314f, "1", false));
        drops.add(new ItemData(5323, 0.011723329425556858f, "1", false));
        drops.add(new ItemData(5292, 0.011185682326621925f, "1", false));
        drops.add(new ItemData(5104, 0.00823045267489712f, "1", false));
        drops.add(new ItemData(5293, 0.0076045627376425855f, "1", false));
        drops.add(new ItemData(5311, 0.007423904974016332f, "1", false));
        drops.add(new ItemData(5321, 0.005636978579481398f, "1", false));
        drops.add(new ItemData(5294, 0.00501002004008016f, "1", false));
        drops.add(new ItemData(22879, 0.0035778175313059034f, "1", false));
        drops.add(new ItemData(5295, 0.0034891835310537334f, "1", false));
        drops.add(new ItemData(5105, 0.0030413625304136255f, "1", false));
    }
