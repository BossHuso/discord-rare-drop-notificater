...
public class Waterelemental implements BaseNPC {
    ...
    public Waterelemental() {
        ...
        drops.add(new ItemData(227, 1f, "1", false));
        ...
        drops.add(new ItemData(555, 0.1015625f, "15", false));
        drops.add(new ItemData(995, 0.28125f, "12", false));
        drops.add(new ItemData(995, 0.0234375f, "42", false));
        drops.add(new ItemData(1383, 0.015625f, "1", false));
