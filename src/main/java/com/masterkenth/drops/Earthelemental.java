...
public class Earthelemental implements BaseNPC {
    ...
    public Earthelemental() {
        ...
        drops.add(new ItemData(1480, 1f, "1", false));
        ...
        drops.add(new ItemData(557, 0.1015625f, "15", false));
        ...
        drops.add(new ItemData(2892, 1f, "1", false));
        ...
        drops.add(new ItemData(557, 0.0234375f, "20", false));
