...
public class Cockathrice implements BaseNPC {
    ...
    public Cockathrice() {
        ...
        drops.add(new ItemData(5318, 0.02857142857142857f, "4", false));
        drops.add(new ItemData(5319, 0.02127659574468085f, "4", false));
        drops.add(new ItemData(5324, 0.014084507042253521f, "4", false));
        drops.add(new ItemData(5322, 0.007042253521126761f, "3", false));
        drops.add(new ItemData(5320, 0.0035087719298245615f, "3", false));
        drops.add(new ItemData(1207, 0.0234375f, "1", false));
        drops.add(new ItemData(5323, 0.0017513134851138354f, "2", false));
        drops.add(new ItemData(5321, 0.0008368200836820083f, "2", false));
        drops.add(new ItemData(22879, 0.0006082725060827251f, "2", false));
        drops.add(new ItemData(5305, 0.008849557522123894f, "4", false));
        drops.add(new ItemData(5307, 0.008771929824561403f, "3", false));
        drops.add(new ItemData(5308, 0.006622516556291391f, "3", false));
        drops.add(new ItemData(5306, 0.006578947368421052f, "2", false));
        drops.add(new ItemData(5309, 0.0043859649122807015f, "2", false));
        drops.add(new ItemData(5310, 0.0021929824561403508f, "2", false));
        drops.add(new ItemData(5311, 0.0011135857461024498f, "1", false));
        drops.add(new ItemData(4121, 0.0078125f, "1", false));
        drops.add(new ItemData(5096, 0.0072992700729927005f, "1", false));
        drops.add(new ItemData(5098, 0.004807692307692308f, "1", false));
        drops.add(new ItemData(5097, 0.003105590062111801f, "1", false));
        drops.add(new ItemData(5099, 0.0022988505747126436f, "1", false));
        drops.add(new ItemData(5100, 0.0018315018315018315f, "1", false));
        drops.add(new ItemData(5101, 0.002531645569620253f, "1", false));
        drops.add(new ItemData(5102, 0.0017699115044247787f, "1", false));
        drops.add(new ItemData(5103, 0.0012642225031605564f, "1", false));
        drops.add(new ItemData(5104, 0.0005058168942842691f, "1", false));
        drops.add(new ItemData(5105, 0.00018331805682859762f, "1", false));
        drops.add(new ItemData(826, 0.0078125f, "5", false));
        drops.add(new ItemData(5106, 0.00006952652436904678f, "1", false));
        ...
        drops.add(new ItemData(2801, 0.078125f, "1", false));
        drops.add(new ItemData(4117, 0.001953125f, "1", false));
        drops.add(new ItemData(7976, 0.001f, "1", false));
        drops.add(new ItemData(20730, 0.002932551319648094f, "1", false));
        drops.add(new ItemData(20736, 0.002932551319648094f, "1", false));
        drops.add(new ItemData(21270, 0.0008389261744966443f, "1", false));
        drops.add(new ItemData(20724, 0.0008389261744966443f, "1", false));
