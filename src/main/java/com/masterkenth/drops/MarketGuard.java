...
public class MarketGuard implements BaseNPC {
    ...
    public MarketGuard() {
        ...
        drops.add(new ItemData(995, 0.328125f, "15", false));
        drops.add(new ItemData(995, 0.0390625f, "17", false));
        drops.add(new ItemData(995, 0.0703125f, "22", false));
        ...
        drops.add(new ItemData(438, 0.0078125f, "5", false));
        drops.add(new ItemData(440, 0.0234375f, "2", false));
        drops.add(new ItemData(1335, 0.046875f, "1", false));
        drops.add(new ItemData(327, 0.0078125f, "1", false));
