...
public class Marblegargoyle implements BaseNPC {
    ...
    public Marblegargoyle() {
        ...
        drops.add(new ItemData(20730, 0.006711409395973154f, "1", false));
        drops.add(new ItemData(20736, 0.006711409395973154f, "1", false));
        drops.add(new ItemData(21270, 0.0019230769230769232f, "1", false));
        drops.add(new ItemData(20724, 0.0019230769230769232f, "1", false));
