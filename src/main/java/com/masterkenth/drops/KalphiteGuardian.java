...
public class KalphiteGuardian implements BaseNPC {
    public List<ItemData> drops;

    public KalphiteGuardian() {
        drops = new ArrayList<>();
        drops.add(new ItemData(1285, 0.03125f, "1", false));
        ...
        drops.add(new ItemData(1211, 0.015625f, "1", false));
        drops.add(new ItemData(1197, 0.0078125f, "1", false));
        drops.add(new ItemData(13489, 0.02857142857142857f, "1", false));
        drops.add(new ItemData(23083, 0.01098901098901099f, "1", false));
