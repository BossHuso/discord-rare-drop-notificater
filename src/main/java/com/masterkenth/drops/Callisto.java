...
public class Callisto implements BaseNPC {
    public List<ItemData> drops;

    public Callisto() {
        drops = new ArrayList<>();
        drops.add(new ItemData(532, 1f, "1", false));
        drops.add(new ItemData(566, 0.0390625f, "250", false));
        ...
        drops.add(new ItemData(6332, 0.046875f, "400", false));
        drops.add(new ItemData(225, 0.0390625f, "25", false));
        drops.add(new ItemData(1513, 0.0390625f, "100", false));
        drops.add(new ItemData(1749, 0.0234375f, "75", false));
        drops.add(new ItemData(5974, 0.015625f, "60", false));
        drops.add(new ItemData(1631, 0.015625f, "1", false));
        drops.add(new ItemData(12603, 0.001953125f, "1", false));
        drops.add(new ItemData(3049, 0.0078125f, "100", false));
        drops.add(new ItemData(5295, 0.0390625f, "5", false));
        drops.add(new ItemData(5300, 0.0390625f, "3", false));
        ...
        drops.add(new ItemData(536, 0.0234375f, "30", false));
        ...
        drops.add(new ItemData(13178, 0.0005f, "1", false));
