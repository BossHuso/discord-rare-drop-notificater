...
public class Monstrousbasilisk implements BaseNPC {
    public List<ItemData> drops;

    public Monstrousbasilisk() {
        drops = new ArrayList<>();
        ...
        drops.add(new ItemData(20730, 0.0034129692832764505f, "1", false));
        drops.add(new ItemData(20736, 0.0034129692832764505f, "1", false));
        drops.add(new ItemData(21270, 0.0009765625f, "1", false));
        drops.add(new ItemData(20724, 0.0009765625f, "1", false));
