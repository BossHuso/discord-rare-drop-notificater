...
public class Barbarian implements BaseNPC {
    ...
    public Barbarian() {
        ...
        drops.add(new ItemData(23182, 0.01818181818181818f, "1", false));
        drops.add(new ItemData(2677, 0.0078125f, "1", false));
        drops.add(new ItemData(995, 0.328125f, "5", false));
        drops.add(new ItemData(995, 0.0703125f, "8", false));
        drops.add(new ItemData(995, 0.0390625f, "17", false));
        drops.add(new ItemData(995, 0.0234375f, "27", false));
        ...
        drops.add(new ItemData(23182, 0.013333333333333334f, "1", false));
        drops.add(new ItemData(562, 0.03125f, "2", false));
        drops.add(new ItemData(882, 0.0234375f, "15", false));
        drops.add(new ItemData(557, 0.0234375f, "2", false));
        drops.add(new ItemData(554, 0.015625f, "5", false));
        drops.add(new ItemData(558, 0.015625f, "5", false));
