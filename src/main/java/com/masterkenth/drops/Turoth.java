...
public class Turoth implements BaseNPC {
    ...
    public Turoth() {
        ...
        drops.add(new ItemData(199, 0.06060606060606061f, "1-3", false));
        drops.add(new ItemData(201, 0.045454545454545456f, "1-3", false));
        drops.add(new ItemData(203, 0.034013605442176874f, "1-3", false));
        drops.add(new ItemData(205, 0.026455026455026454f, "1-3", false));
        drops.add(new ItemData(207, 0.020833333333333332f, "1-3", false));
        drops.add(new ItemData(209, 0.015128593040847202f, "1-3", false));
        drops.add(new ItemData(211, 0.011350737797956867f, "1-3", false));
        drops.add(new ItemData(213, 0.00946073793755913f, "1-3", false));
        drops.add(new ItemData(1069, 0.0546875f, "1", false));
        drops.add(new ItemData(215, 0.00757002271006813f, "1-3", false));
        drops.add(new ItemData(2485, 0.0056753688989784334f, "1-3", false));
        drops.add(new ItemData(217, 0.0056753688989784334f, "1-3", false));
        ...
        drops.add(new ItemData(225, 0.0546875f, "1", false));
        drops.add(new ItemData(995, 0.2265625f, "44", false));
        drops.add(new ItemData(995, 0.09375f, "132", false));
        ...
        drops.add(new ItemData(23083, 0.008f, "1", false));
        drops.add(new ItemData(1213, 0.0078125f, "1", false));
        drops.add(new ItemData(11902, 0.002f, "1", false));
        drops.add(new ItemData(4113, 0.001953125f, "1", false));
        drops.add(new ItemData(563, 0.046875f, "3", false));
    }
