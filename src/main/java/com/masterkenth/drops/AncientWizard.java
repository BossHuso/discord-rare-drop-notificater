...
public class AncientWizard implements BaseNPC {
    ...
    public AncientWizard() {
        ...
        drops.add(new ItemData(1393, 0.02f, "1", false));
        ...
        drops.add(new ItemData(1387, 0.02f, "1", false));
        drops.add(new ItemData(9465, 0.02f, "1", false));
        drops.add(new ItemData(11941, 0.3333333333333333f, "1", false));
        drops.add(new ItemData(556, 0.1f, "5-24", false));
        drops.add(new ItemData(554, 0.1f, "5-24", false));
        drops.add(new ItemData(560, 0.1f, "5-24", false));
        drops.add(new ItemData(9144, 0.1f, "1-5", false));
