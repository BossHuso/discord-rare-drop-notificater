...
public class KingSandCrab implements BaseNPC {
    ...
    public KingSandCrab() {
        ...
        drops.add(new ItemData(19677, 0.005f, "1", false));
        drops.add(new ItemData(19679, 0.0033333333333333335f, "1", false));
        drops.add(new ItemData(19681, 0.0033333333333333335f, "1", false));
        drops.add(new ItemData(19683, 0.0033333333333333335f, "1", false));
