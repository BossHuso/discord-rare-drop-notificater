...
public class Crushinghand implements BaseNPC {
    ...
    public Crushinghand() {
        ...
        drops.add(new ItemData(20730, 0.002544529262086514f, "1", false));
        drops.add(new ItemData(20736, 0.002544529262086514f, "1", false));
        drops.add(new ItemData(21270, 0.0007267441860465116f, "1", false));
        drops.add(new ItemData(20724, 0.0007267441860465116f, "1", false));
