...
public class Nightbeast implements BaseNPC {
    ...
    public Nightbeast() {
        ...
        drops.add(new ItemData(12073, 0.008333333333333333f, "1", false));
        ...
        drops.add(new ItemData(20730, 0.0136986301369863f, "1", false));
        drops.add(new ItemData(20736, 0.0136986301369863f, "1", false));
        drops.add(new ItemData(21270, 0.00390625f, "1", false));
        drops.add(new ItemData(20724, 0.00390625f, "1", false));
