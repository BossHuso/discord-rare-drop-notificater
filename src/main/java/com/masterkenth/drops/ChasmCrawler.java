...
public class ChasmCrawler implements BaseNPC {
    ...
    public ChasmCrawler() {
        ...
        drops.add(new ItemData(20730, 0.002617801047120419f, "1", false));
        drops.add(new ItemData(20736, 0.002617801047120419f, "1", false));
        drops.add(new ItemData(21270, 0.0007485029940119761f, "1", false));
        drops.add(new ItemData(20724, 0.0007485029940119761f, "1", false));
