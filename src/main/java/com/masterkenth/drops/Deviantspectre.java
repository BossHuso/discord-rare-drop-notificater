...
public class Deviantspectre implements BaseNPC {
    public List<ItemData> drops;

    public Deviantspectre() {
        drops = new ArrayList<>();
        ...
        drops.add(new ItemData(23083, 0.014705882352941176f, "1", false));
        drops.add(new ItemData(2722, 0.0078125f, "1", false));
        drops.add(new ItemData(4103, 0.001953125f, "1", false));
        drops.add(new ItemData(19677, 0.0048543689320388345f, "1", false));
        drops.add(new ItemData(3053, 0.0078125f, "1", false));
        drops.add(new ItemData(19679, 0.0032258064516129032f, "1", false));
        drops.add(new ItemData(19681, 0.0032258064516129032f, "1", false));
        drops.add(new ItemData(19683, 0.0032258064516129032f, "1", false));
