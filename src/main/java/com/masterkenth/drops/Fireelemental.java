...
public class Fireelemental implements BaseNPC {
    ...
    public Fireelemental() {
        ...
        drops.add(new ItemData(554, 0.1015625f, "15", false));
        drops.add(new ItemData(995, 0.28125f, "12", false));
        drops.add(new ItemData(995, 0.0234375f, "42", false));
        drops.add(new ItemData(1387, 0.015625f, "1", false));
        ...
        drops.add(new ItemData(554, 0.0234375f, "20", false));
