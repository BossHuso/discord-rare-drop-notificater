...
public class BasiliskKnight implements BaseNPC {
    public List<ItemData> drops;

    public BasiliskKnight() {
        drops = new ArrayList<>();
        ...
        drops.add(new ItemData(995, 0.1346153846153846f, "500-2499", false));
        ...
        drops.add(new ItemData(23083, 0.015873015873015872f, "1", false));
        drops.add(new ItemData(4109, 0.00390625f, "1", false));
        drops.add(new ItemData(2722, 0.005208333333333333f, "1", false));
        drops.add(new ItemData(7977, 0.001f, "1", false));
        drops.add(new ItemData(10976, 0.0025f, "1", false));
        drops.add(new ItemData(24268, 0.0002f, "1", false));
