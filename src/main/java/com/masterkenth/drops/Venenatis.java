...
public class Venenatis implements BaseNPC {
    public List<ItemData> drops;

    public Venenatis() {
        drops = new ArrayList<>();
        drops.add(new ItemData(12605, 0.001953125f, "1", false));
        drops.add(new ItemData(9243, 0.0390625f, "100", false));
        ...
        drops.add(new ItemData(9194, 0.0390625f, "60", false));
        drops.add(new ItemData(1513, 0.0390625f, "100", false));
        drops.add(new ItemData(225, 0.0390625f, "25", false));
        drops.add(new ItemData(223, 0.0234375f, "500", false));
        drops.add(new ItemData(237, 0.015625f, "100", false));
        drops.add(new ItemData(1275, 0.09375f, "1", false));
        drops.add(new ItemData(1631, 0.015625f, "1", false));
        drops.add(new ItemData(3051, 0.0078125f, "100", false));
        ...
        drops.add(new ItemData(5952, 0.0234375f, "10", false));
        ...
        drops.add(new ItemData(868, 0.0390625f, "60", false));
        ...
        drops.add(new ItemData(13177, 0.0005f, "1", false));
