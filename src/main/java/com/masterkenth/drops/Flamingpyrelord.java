...
public class Flamingpyrelord implements BaseNPC {
    public List<ItemData> drops;

    public Flamingpyrelord() {
        drops = new ArrayList<>();
        ...
        drops.add(new ItemData(995, 0.1875f, "40", false));
        drops.add(new ItemData(995, 0.15625f, "120", false));
        drops.add(new ItemData(995, 0.078125f, "200", false));
        drops.add(new ItemData(995, 0.015625f, "450", false));
        ...
        drops.add(new ItemData(20730, 0.0030581039755351682f, "1", false));
        drops.add(new ItemData(20736, 0.0030581039755351682f, "1", false));
        drops.add(new ItemData(21270, 0.0008741258741258741f, "1", false));
        drops.add(new ItemData(20724, 0.0008741258741258741f, "1", false));
        ...
        drops.add(new ItemData(554, 0.1640625f, "30", false));
