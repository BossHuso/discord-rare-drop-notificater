...
public class MalevolentMage implements BaseNPC {
    public List<ItemData> drops;

    public MalevolentMage() {
        drops = new ArrayList<>();
        ...
        drops.add(new ItemData(20730, 0.0036496350364963502f, "1", false));
        drops.add(new ItemData(20736, 0.0036496350364963502f, "1", false));
        drops.add(new ItemData(21270, 0.0010416666666666667f, "1", false));
        drops.add(new ItemData(20724, 0.0010416666666666667f, "1", false));
