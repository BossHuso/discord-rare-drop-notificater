...
public class Zombiepirate implements BaseNPC {
    ...
    public Zombiepirate() {
        ...
        drops.add(new ItemData(995, 0.015625f, "40", false));
        drops.add(new ItemData(313, 0.1640625f, "7", false));
        drops.add(new ItemData(313, 0.0390625f, "10", false));
        drops.add(new ItemData(6716, 0.0234375f, "1", false));
        ...
        drops.add(new ItemData(877, 0.0234375f, "2-12", false));
        ...
        drops.add(new ItemData(555, 0.0078125f, "17", false));
