...
public class ShadowWyrm implements BaseNPC {
    ...
    public ShadowWyrm() {
        ...
        drops.add(new ItemData(21009, 0.0005f, "1", false));
        ...
        drops.add(new ItemData(21028, 0.0005f, "1", false));
        ...
        drops.add(new ItemData(22804, 0.0005f, "75-150", false));
        ...
        drops.add(new ItemData(20849, 0.0005f, "75-150", false));
        ...
        drops.add(new ItemData(20730, 0.004807692307692308f, "1", false));
        drops.add(new ItemData(20736, 0.004807692307692308f, "1", false));
        drops.add(new ItemData(21270, 0.0013736263736263737f, "1", false));
        drops.add(new ItemData(20724, 0.0013736263736263737f, "1", false));
