...
public class Torturedsoul implements BaseNPC {
    public List<ItemData> drops;

    public Torturedsoul() {
        drops = new ArrayList<>();
        drops.add(new ItemData(559, 0.0546875f, "7", false));
        ...
        drops.add(new ItemData(995, 0.0078125f, "12", false));
        drops.add(new ItemData(995, 0.015625f, "2", false));
        drops.add(new ItemData(995, 0.0234375f, "6", false));
        drops.add(new ItemData(995, 0.0234375f, "5", false));
        drops.add(new ItemData(995, 0.234375f, "3", false));
        drops.add(new ItemData(995, 0.1640625f, "2", false));
        drops.add(new ItemData(205, 0.0390625f, "1", false));
        drops.add(new ItemData(225, 0.0234375f, "1", false));
        drops.add(new ItemData(227, 0.0078125f, "1", false));
        drops.add(new ItemData(203, 0.0234375f, "1", false));
        drops.add(new ItemData(201, 0.015625f, "1", false));
        drops.add(new ItemData(199, 0.0078125f, "1", false));
